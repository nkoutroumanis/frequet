...
public class VRERecordMaterializer extends RecordMaterializer<VRERecord> {
    ...
    public VRERecord getCurrentRecord() {
        ...
        return new VRERecord(objectId, serialNumber, segmentType, spatialPoints, minLongitude, minLatitude, maxLongitude, maxLatitude, null, null, signature);
    }
