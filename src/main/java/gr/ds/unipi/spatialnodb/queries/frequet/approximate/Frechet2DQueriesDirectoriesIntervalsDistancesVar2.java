...
//        System.exit(7);
        ...
        String fullPathExportedFile = metricsPath+ File.separator+"frechet-queries-approximate-distances-var2-"+Paths.get(parquetPath).getFileName().toString()+"-"+ Paths.get(queriesFilePath).getFileName().toString().replaceFirst("\\.[^.]+$", "")+".txt";
