...
public class Frechet2DQueriesDirectoriesIntervalsDistancesVar3 {
...
//        Broadcast<SmallHilbertCurve> smallHilbertCurveBr = jsc.<SmallHilbertCurve>broadcast(hilbertCurve);
        ...
        String fullPathExportedFile = metricsPath+ File.separator+"prunings-frechet-queries-distances-var3-"+Paths.get(parquetPath).getFileName().toString()+"-"+ Paths.get(queriesFilePath).getFileName().toString().replaceFirst("\\.[^.]+$", "")+".txt";
...
//                                sb.append(parquetPath+ File.separator+"stIndex"+File.separator+r+",");
            ...
            pairRDDRangeQuery = (JavaPairRDD<Long, TrajectorySegmentWithIntervalMetadata>) jsc.newAPIHadoopFile(sb.toString()/*parquetPath+ File.separator+"stIndex"+File.separator*/, ParquetInputFormatWithKey.class, Long.class, TrajectorySegmentWithIntervalMetadata.class, job.getConfiguration());
