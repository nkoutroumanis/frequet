...
//        System.exit(7);
        ...
        String fullPathExportedFile = metricsPath+ File.separator+"frechet-"+epsilon+"-"+"distances-var4-"+Paths.get(parquetPath).getFileName().toString()+"-"+ Paths.get(queriesFilePath).getFileName().toString().replaceFirst("\\.[^.]+$", "")+".txt";
