...
//                            }
                            ...
                            for (int i1 = 1; i1 < passingSegments.size(); i1++) {
                                if(passingSegments.get(i1-1)._2[1].getTimestamp() != passingSegments.get(i1)._2[0].getTimestamp() || passingSegments.get(i1-1)._2[1].getLongitude() != passingSegments.get(i1)._2[0].getLongitude() || passingSegments.get(i1-1)._2[1].getLatitude() != passingSegments.get(i1)._2[0].getLatitude()){
                                    throw new Exception("Problem with the passing segments list. A point seems not to be the same with the first point in the next segment. Object id: "+f._1+" Points: "+passingSegments.get(i1-1)._2[0] + ","+passingSegments.get(i1-1)._2[1] + " - "+passingSegments.get(i1)._2[0]+","+passingSegments.get(i1)._2[1]);
                                }
                            }
        ...
        try(BufferedWriter bf = new BufferedWriter(new FileWriter(metricsPathExport+ File.separator+"data-loading-trajparquet-"+ Paths.get(writePath).getFileName().toString()+".txt"))) {
            bf.write("Write Time");
            bf.newLine();
